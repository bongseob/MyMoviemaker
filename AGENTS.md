...
This file is for Codex/OpenAI coding agents working in this repository. Shared project rules live in `PROJECT_RULES.md`; read that first and keep this file focused on Codex-specific workflow.
